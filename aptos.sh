...
mv ~/aptos-node /usr/local/bin
mv ~/aptos-operational-tool /usr/local/bin
...
wget https://raw.githubusercontent.com/aptos-labs/aptos-core/main/config/src/config/test_data/public_full_node.yaml 
cp ~/public_full_node.yaml ~/.aptos/config
